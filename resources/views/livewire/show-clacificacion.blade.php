    ...
    <div class="card uppercase" bis_skin_checked="1">
        <div class="card-header" style="padding: .75rem .25rem" bis_skin_checked="1">
            <div class="input-group mb-3">
                ...
                <a href="{{route('admin.clacificacions.create')}}" class="btn bg-navy btn-sm px-2 elevation-4"><i class="fas fa-plus mt-2 px-3"></i></a>
            </div>
        </div>
        <!-- /.card-header -->
                        ...
                        <tr>
                            ...
                            <td width="4px"> 
                                @if ($clacificacion->estatus == 1)
                                    <form class="formulario-estatus" action="{{route('admin.clacificacions.show', $clacificacion)}}" method="get">
                                        @csrf
                            ...
                            <td width="4px">
                                <a class="btn btn-outline-info btn-sm mr-1 elevation-4" href=" {{route('admin.clacificacions.edit',$clacificacion)}} "><i class="fas fa-edit"></i></a>
                            </td>
                            <td width="4px">
                                <form class="formulario-eliminar" action="{{route('admin.clacificacions.destroy', $clacificacion)}}" method="POST">
                                    @csrf
                                    @method('delete')
